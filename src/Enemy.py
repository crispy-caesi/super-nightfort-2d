...
# ============== horizontal player movement ============== #
    ...
    def horizontalMovement(self, tilemaprect):
        """
        ...
        print(f"[DEBUG] Enemy: moveLeft: {self.moveLeft}; moveRight: {self.moveRight}; Position: ({self.rect.x}|{self.rect.y})")
...
# ============== vertical player movement ============== #
    ...
    def verticalMovement(self, tilemaprect):
        """
...
# ============== update ============== #
    ...
    def enemyUpdate(self, tilemaprect):
        """
        Method to update all player related events.
        """
        
        self.horizontalMovement(tilemaprect)
        self.verticalMovement(tilemaprect)
        self.collisionBoxUpdate()
